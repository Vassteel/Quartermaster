...
[BepInPlugin("local.valheim.quartermaster", "Quartermaster", "0.1.3")]
...
public sealed class Plugin : BaseUnityPlugin
{
    ...
    internal static ConfigEntry<bool> Enabled, CraftFromContainers, ExtendStationCoverage;
    ...
    private void Update()
    {
        ...
        {
            if (inWorld) { ContainerRegistry.Clear(); Automation.Clear(); ChestUi.Close(); inWorld = false; }
            return;
        }
        inWorld = true;
        ChestUi.Tick();
    ...
    private void OnDestroy() { harmony?.UnpatchSelf(); ChestUi.Dispose(); ContainerRegistry.Clear(); Automation.Clear(); }
}
